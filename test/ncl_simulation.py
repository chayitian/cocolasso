...
def run_single_experiment(cov_type: str, error_type: str,
        ...
        for mc in range(n_mc):
            ...
            try:
                metrics = run_single_experiment(
                    cov_type, error_type, tau, seed, Sigma_X
                )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="NCL 模拟实验")
    ...
    output_path = os.path.join(output_dir, "ncl_simulation_results.csv")
